    ...
    <>
      ...
      <Nav />
        <Routes>
            ...
            <Route path='/contact'  element={<Contact title={documentTitle.contact}/>} />
            <Route path='/projects' element={<Projects title={documentTitle.projects}/>} />
            <Route path='/resume' element={<Resume title={documentTitle.resume}/>} />
        </Routes>
    </Router>
    </>
  )
